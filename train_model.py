...
options = {
    ...
    "2": "Create GradientBoostingRegressor model - Multiple Output",
    "3": "Create GradientBoostingRegressor model - Single Output"
}
...
consider = ["W Distortion zeta","W Distortion delta","W Distortion sigma","W Distortion theta","P Distortion zeta","P Distortion delta","P Distortion sigma","P bonds","P-W dist","?1 atomic number","?1 bonds","W-P-?1 angle","P-?1 dist","?2 atomic number","?2 bonds","W-P-?2 angle","P-?2 dist","?3 atomic number","?3 bonds","W-P-?3 angle","P-?3 dist"]
